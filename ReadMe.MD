...
- Phase 7.5 — Online-safety migration classification (`OnlineSafe` / `FastLockDestructiveGuarded` / `ExpandContract` / `OfflineOnly`); two-phase rename + type-widening; lock-timeout DDL; backfill orchestration.
- Phase 8+ — Rhai shell.
