...
### `pk = "heerid" | "ranjid" | "serial" | "none"` — default: `"heerid"`
...
```rust
#[model(table = "posts")]  // pk="heerid" is the default
pub struct Post { ... }
```
