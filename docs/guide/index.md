...
| [Cross-Model Set Operations](./cross-model-set-ops.md) | `union_as`/`intersect_as`/`except_as` across different Model types, decode target `R`, visage arms, arm restrictions, outer modifiers, tenant reconciliation |
