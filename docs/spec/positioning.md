...
| Migration file format | SQL up/down (descriptor-generated); author-edited `.sql` for data-only / out-of-band ops (re-compose preserves edits via `--force-overwrite`) | Rust code (generated) | Rust trait impl OR raw SQL | Paired SQL files |
