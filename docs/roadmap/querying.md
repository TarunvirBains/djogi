...
> query layer; the API is now live across (`QuerySet<T>` + filters
> + bulk update/delete), (expression IR, annotations, aggregates),
> and (grouped aggregation type-state). The authoritative
