...
| [CLI](./cli.md) | Shipped (Phase 7) — except `rollback`, `baseline`, and `repair` CLI dispatchers are deferred; `apply --fake` ships as a flag on the apply command | [Migrations](../guide/migrations.md) |
