...
| [CLI](./cli.md) | Shipped (Phase 7) — except `rollback` and `baseline` CLI dispatchers are deferred; `apply --fake` ships as a flag on the apply command | [Migrations](../guide/migrations.md) |
