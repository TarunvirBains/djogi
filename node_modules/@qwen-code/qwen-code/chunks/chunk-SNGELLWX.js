...
var HooksConfigSource = /* @__PURE__ */ ((HooksConfigSource2) => {
  ...
  HooksConfigSource2["Session"] = "session";
  return HooksConfigSource2;
})(HooksConfigSource || {});
...
var HookPhase = /* @__PURE__ */ ((HookPhase2) => {
  HookPhase2["Validation"] = "validation";
  HookPhase2["PostWrite"] = "postWrite";
  return HookPhase2;
})(HookPhase || {});
...
var NotificationType = /* @__PURE__ */ ((NotificationType2) => {
  NotificationType2["PermissionPrompt"] = "permission_prompt";
  NotificationType2["IdlePrompt"] = "idle_prompt";
  NotificationType2["AuthSuccess"] = "auth_success";
  NotificationType2["ElicitationDialog"] = "elicitation_dialog";
  return NotificationType2;
})(NotificationType || {});
var SessionStartSource = /* @__PURE__ */ ((SessionStartSource2) => {
  SessionStartSource2["Startup"] = "startup";
  SessionStartSource2["Resume"] = "resume";
  SessionStartSource2["Clear"] = "clear";
  SessionStartSource2["Compact"] = "compact";
  SessionStartSource2["Branch"] = "branch";
  return SessionStartSource2;
})(SessionStartSource || {});
...
var SessionEndReason = /* @__PURE__ */ ((SessionEndReason2) => {
  SessionEndReason2["Clear"] = "clear";
  SessionEndReason2["Logout"] = "logout";
  SessionEndReason2["PromptInputExit"] = "prompt_input_exit";
  SessionEndReason2["Bypass_permissions_disabled"] = "bypass_permissions_disabled";
  SessionEndReason2["Other"] = "other";
  return SessionEndReason2;
})(SessionEndReason || {});
var PreCompactTrigger = /* @__PURE__ */ ((PreCompactTrigger2) => {
  PreCompactTrigger2["Manual"] = "manual";
  PreCompactTrigger2["Auto"] = "auto";
  return PreCompactTrigger2;
})(PreCompactTrigger || {});
var PostCompactTrigger = /* @__PURE__ */ ((PostCompactTrigger2) => {
  PostCompactTrigger2["Manual"] = "manual";
  PostCompactTrigger2["Auto"] = "auto";
  return PostCompactTrigger2;
})(PostCompactTrigger || {});
var AgentType = /* @__PURE__ */ ((AgentType2) => {
  AgentType2["Bash"] = "Bash";
  AgentType2["Explorer"] = "Explorer";
  AgentType2["Plan"] = "Plan";
