...
init_esbuild_shims();
var debugLogger = createDebugLogger("DashScopeOpenAICompatibleProvider");
...
init_esbuild_shims();
var OpenRouterOpenAICompatibleProvider = class extends DefaultOpenAICompatibleProvider {
  static {
    __name(this, "OpenRouterOpenAICompatibleProvider");
  }
  constructor(contentGeneratorConfig, cliConfig) {
    super(contentGeneratorConfig, cliConfig);
  }
