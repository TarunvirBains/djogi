...
var SessionRouter = class {
  ...
  async restoreSessions() {
    if (!this.persistPath || !existsSync2(this.persistPath)) {
      return { restored: 0, failed: 0 };
    }
    let entries;
    try {
      entries = JSON.parse(readFileSync2(this.persistPath, "utf-8"));
    } catch {
      return { restored: 0, failed: 0 };
    }
    let restored = 0;
  ...
  persist() {
    ...
    try {
      writeFileSync2(this.persistPath, JSON.stringify(data, null, 2), "utf-8");
    } catch {
    }
  }
};
