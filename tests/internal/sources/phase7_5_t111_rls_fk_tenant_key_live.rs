// Phase 5.5 / T11.1 — Live integration test: tenant_key + ForeignKey<T> RLS
//
// Regression test for [GH issue #37]. Phase 5 / Phase 5.5 already cover
...
/// file containing the policy DDL it would apply once Phase 7's
