...
// `tests/integration/defer_constraints.rs`.
#[djogi::djogi_test(sync_models = [DogfoodWidget])]
...
// DDL metadata slice (#217/#218/#219). The remaining gap
// rows stay routed to #220/#221.
//
// Routed to djogi#172 (umbrella issue; small pieces such as
// COMMENT ON may move to a different issue by amendment).
#[djogi::djogi_test(sync_models = [DogfoodDdl])]
