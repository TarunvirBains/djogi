//! Phase 7 T10-01 — assert that the two table-creation paths produce
...
//!
//! - **Path A — `sync_models`** (Phase 7 T10): the test-time helper
...
//!
//! - **Path B — `apply_plan`** (Phase 7 T4): the production migration
